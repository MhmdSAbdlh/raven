...
public class PanelDay extends DynamicCell<ModelDate> {
	...
	public static final String DATE[][] = { { "Do", "Lu", "Ma", "Mi", "Ju", "Vi", "Sa" },
			{ "Do", "Se", "Te", "Qu", "Qi", "Sx", "Sa" }, { "Su", "Mo", "Tu", "We", "Th", "Fr", "Sa" },
			{ "Di", "Le", "Ma", "Me", "Je", "Ve", "Sa" } };
	private CalendarCellListener calendarCellListener;
	private PanelDateListener panelDateListener;
	private int language;

	public PanelDay(int lang) {
		this.language = lang;
		init();
	}
	...
	private void init() {
		putClientProperty(FlatClientProperties.STYLE,
				"" + "border:40,0,0,0;" + "background:if($Calendar.background,$Calendar.background,$Panel.background)");
	...
	public String getMonthYear() {
		return PanelMonth.MONTH[language][month.getMonth() - 1] + " - " + month.getYear();
	}
