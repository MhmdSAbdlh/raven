...
public class Toast {
	...
	public static String show(Component owner, Type type, String message, ToastLocation location) {
		...
		option.getLayoutOption().setLocation(location);
	...
	public static String showPromise(Component owner, String message, ToastLocation location, ToastOption option,
	...
	private static String show(Component owner, Type type, Object object, ToastOption option, ToastPromise promise) {
		...
		ToastPanel toastPanel = new ToastPanel(toastContainerLayer, toastOwner,
				new ToastPanel.ToastData(type, option, themesData, message), toastId);
