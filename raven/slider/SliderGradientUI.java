...
public class SliderGradientUI extends BasicSliderUI {
	...
	public void paintThumb(Graphics grphcs) {
		...
		g2.setPaint(new GradientPaint(0, 0, new Color(237, 237, 237), thumbRect.width, thumbRect.height,
				new Color(205, 205, 205)));
		g2.fill(new Ellipse2D.Double(0, 0, thumbRect.width, thumbRect.height));
		g2.setPaint(new GradientPaint(0, 0, new Color(243, 243, 243), thumbRect.width, thumbRect.height,
				new Color(210, 210, 210)));
		g2.fill(new Ellipse2D.Double(1, 1, thumbRect.width - 2, thumbRect.height - 2));
		g2.setTransform(tra);
		g2.setPaint(new GradientPaint(trackRect.x, trackRect.y, sliderGradient.getColor1(), trackRect.width,
				trackRect.height, sliderGradient.getColor2()));
