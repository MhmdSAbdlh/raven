...
public final class Months extends javax.swing.JPanel {
	...
	private void initComponents() {
		...
		cmd1.setText(MONTH_NAMES[language][0]);
		...
		cmd2.setText(MONTH_NAMES[language][1]);
		...
		cmd3.setText(MONTH_NAMES[language][2]);
		...
		cmd4.setText(MONTH_NAMES[language][3]);
		...
		cmd5.setText(MONTH_NAMES[language][4]);
		...
		cmd6.setText(MONTH_NAMES[language][5]);
		...
		cmd7.setText(MONTH_NAMES[language][6]);
		...
		cmd8.setText(MONTH_NAMES[language][7]);
		...
		cmd9.setText(MONTH_NAMES[language][8]);
		...
		cmd10.setText(MONTH_NAMES[language][9]);
		...
		cmd11.setText(MONTH_NAMES[language][10]);
		...
		cmd12.setText(MONTH_NAMES[language][11]);
